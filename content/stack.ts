...
export const stack: readonly StackGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'did:web', primary: false },
      { name: 'OID4VCI / OID4VP', primary: false },
      { name: 'x402', primary: false },
  ...
  },
  {
    id: 'frontend',
    title: 'Interfaces',
    note: 'Enough frontend to ship the whole product, not just the API behind it.',
    items: [
  ...
  },
  {
    id: 'platform',
    title: 'Platform',
    note: 'Containers, pipelines and S3-compatible storage.',
    items: [
